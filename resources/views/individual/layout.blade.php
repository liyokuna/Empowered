...
/*Effect on logo*/
.image_cv {
	background: url("pictures/application.png") center no-repeat;
	margin:auto;
	width:60%;
	height:100px;
}
.image_social {
	background: url("pictures/LinkedIn-96.png") center no-repeat;
	margin:auto;
	width:60%;
	height:100px;
}
.image_git {
	background: url("pictures/GitHub-96.png") center no-repeat;
	margin:auto;
	width:60%;
	height:100px;
}
...
.image_cv:hover {
	...
	background-image:url("pictures/Word-100.png");
}
.image_social:hover {
	
	background-image:url("pictures/viadeo.png");
}
.image_git:hover {
	
	background-image:url("pictures/Bitbucket-96.png");
}
...
<nav class="navbar navbar-inverse navbar-fixed-top">
	<div class="container">
		...
		@include('individual.partials.navbar')
		</div>
	</div>
</nav>
...
@include('individual.partials.footer')
</body>
</html>