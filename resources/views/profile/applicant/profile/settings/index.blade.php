...
<div class="container">
	<div class="row">
			...
			<div class="col-lg-4 text-center">
				<p><span class="glyphicon glyphicon-edit"></span><a class="btn btn-info btn-link" href="/profile/applicant/profile/settings/{{$credentials->id}}/edit" role="button">Edit</a></p>
				<hr>
			</div>
